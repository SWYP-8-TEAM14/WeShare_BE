...
urlpatterns = [
    path("api/v1/users/", UserView.as_view(), name="user_home"),
    ...
    path("api/v1/user/auth/kakao/login/callback/", KakaoCallbackView.as_view(), name="kakao-callback"),
    path("api/v1/user/auth/naver/", NaverLoginView.as_view(), name="naver-login"),
    path("api/v1/user/auth/naver/login/callback/", NaverCallbackView.as_view(), name="naver-callback"),
