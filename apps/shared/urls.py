...
from .views import ItemAddView, ItemView, ItemDetailView, ItemReservationsView, ItemReservationsListView, ItemPickupView, ItemReturnView, ItemReturnListView, UserAddView
...
urlpatterns = [
    ...
    path("users", UserAddView.as_view()),
]
